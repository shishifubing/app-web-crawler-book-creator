...
final class CoverXHTML extends InnerFiles {

    CoverXHTML(EpubBook epubBook) {
	...
	for (String string : epubBook.summary()) {
	    addContent("      <div>\r\n");
	    addContent("        <br/>" + escapeHtml(string) + "\r\n");
	    addContent("      </div>\r\n");
	    addContent("\r\n");
	}
	...
	addContent("\r\n"); 
	addContent("  <div>\r\n"); 
	addContent("    The story is taken from here: <a href=\"" + epubBook.url() + "\">"+epubBook.url()+"</a>\r\n"); 
	addContent("  </div>\r\n");
	addContent("</body>\r\n"); 
	addContent("</html>");
    }
